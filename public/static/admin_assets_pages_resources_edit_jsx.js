"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["admin_assets_pages_resources_edit_jsx"],{
...
/***/ "./admin/assets/pages/resources/edit.jsx":
/*!***********************************************!*\
  !*** ./admin/assets/pages/resources/edit.jsx ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function create(_ref) {
  ...
  function onSubmit(e) {
    e.preventDefault();
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_0__.Inertia.post(route('admin.resources.store'), new FormData(e.target));
  }
