"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["admin_assets_pages_teams_create_jsx"],{
...
/***/ "./admin/assets/pages/teams/create.jsx":
/*!*********************************************!*\
  !*** ./admin/assets/pages/teams/create.jsx ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ createTeam)
/* harmony export */ });
...
function createTeam(_ref) {
  ...
  function onSubmit(e) {
    e.preventDefault();
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_0__.Inertia.post(route('admin.teams.store'), new FormData(e.target));
  }
