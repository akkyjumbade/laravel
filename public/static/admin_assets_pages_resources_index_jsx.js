"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["admin_assets_pages_resources_index_jsx"],{
...
/***/ "./admin/assets/pages/resources/index.jsx":
/*!************************************************!*\
  !*** ./admin/assets/pages/resources/index.jsx ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function resources(_ref) {
  ...
  var cols = Object.keys((_resources$data$ = resources.data[0]) !== null && _resources$data$ !== void 0 ? _resources$data$ : {}).map(function (ok) {
    return {
      key: ok,
      name: ok
    };
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (search && search.length) {
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_2__.Inertia.get(route('admin.resources.index', {
        q: search
      }));
    }
  }, [search]);
