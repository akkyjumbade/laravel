<section x-data='{ drives: @json($drives), c: @json($recentItems) }'>
   <div class="p-4">
      <div class="grid grid-cols-4 gap-3">
         <template x-for="drive in Object.values(drives)">
            <div class="bg-white p-3 rounded-xl">
               <p class="font-bold mb-1" x-html="drive.driver"></p>
               <p class="text-xs text-gray-600 overflow-ellipsis max-w-full overflow-auto" x-html="drive.root"></p>
            </div>
         </template>
      </div>
   </div>
   <div class="relative m-3 flex flex-wrap mx-auto justify-center">
      <template x-for="recentItem in recentItems" >
         <x-admin-storage-item ></x-admin-storage-item>
