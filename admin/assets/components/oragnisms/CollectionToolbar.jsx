...
export default function CollectionToolbar({ selectedRows, onDeleteMany, children, onAction, actions }) {
   return (
      <div className="container mx-auto mb-4 flex flex-col gap-4">
         <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="md:w-6/12">
               <div className="flex items-center gap-1 flex-1">
                  <input placeholder="Search" className="border dark:text-white dark:bg-slate-600 dark:focus:ring-slate-800 dark:hover:bg-slate-700 focus:outline-none focus:ring-4 focus:ring-blue-600 font-medium px-3 py-1 leading-7 rounded-lg sm:w-auto w-full" />
                  <TextInput />
